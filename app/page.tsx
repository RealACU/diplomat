    ...
    <div>
      <div className="flex-col sm:flex sm:flex-row h-[745px] sm:h-screen justify-between overflow-hidden">
        <div className="relative flex-grow w-full xl:flex-1">
          ...
          <h1 style={{ lineHeight: '1.2' }} className="relative sm:absolute text-5xl sm:text-8xl 2xl:text-9xl font-semibold sm:text-left text-center px-4 sm:px-16 pt-64 sm:pt-20 z-30 text-navy-100">
            Your gateway to everything Model UN
          </h1>
          <div className="relative sm:absolute my-12 sm:my-0 sm:mt-[480px] 2xl:mt-[580px] sm:mx-16 gap-x-6 flex sm:flex-row flex-col">
