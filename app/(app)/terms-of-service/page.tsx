      ...
      <div className="terms-content">
        <h1 className="terms-heading">AGREEMENT TO OUR LEGAL TERMS</h1>
          <p>
            ...
            company registered in Nevada, United States, located at 1411 Robin St,
            Las Vegas, NV 89106.
          </p>
          ...
          <p>
            ...
            and <strong>Diplomat</strong>, concerning your access to and use of the Services.
        ...
        <h1 className="terms-heading">TABLE OF CONTENTS</h1>
          <ul className="terms-list">
            ...
            <li>
                <a onClick={() => handleScrollToSection('userreps')} href="#userreps">
            ...
            <li>
                <a onClick={() => handleScrollToSection('prohibited')} href="#prohibited">
            ...
            <li>
                <a onClick={() => handleScrollToSection('socialmedia')} href="#socialmedia">
                    8. SOCIAL MEDIA
                </a>
            </li>

            <li>
                <a onClick={() => handleScrollToSection('advertisers')} href="#advertisers">
                    9. ADVERTISERS
                </a>
            </li>

            <li>
                <a onClick={() => handleScrollToSection('sitemanage')} href="#sitemanage">
            ...
            <li>
                <a onClick={() => handleScrollToSection('modifications')} href="#modifications">
            ...
            <li>
                <a onClick={() => handleScrollToSection('disputes')} href="#disputes">
                    15. DISPUTE RESOLUTION
                </a>
            </li>

            <li>
                <a onClick={() => handleScrollToSection('corrections')} href="#corrections">
                    16. CORRECTIONS
                </a>
            </li>

            <li>
                <a onClick={() => handleScrollToSection('disclaimer')} href="#disclaimer">
                    17. DISCLAIMER
                </a>
            </li>

            <li>
                <a onClick={() => handleScrollToSection('liability')} href="#liability">
                    18. LIMITATIONS OF LIABILITY
                </a>
            </li>

            <li>
                <a onClick={() => handleScrollToSection('indemnification')} href="#indemnification">
                    19. INDEMNIFICATION
                </a>
            </li>

            <li>
                <a onClick={() => handleScrollToSection('userdata')} href="#userdata">
                    20. USER DATA
                </a>
            </li>

            <li>
                <a onClick={() => handleScrollToSection('electronic')} href="#electronic">
                    21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
                </a>
            </li>

            <li>
                <a onClick={() => handleScrollToSection('california')} href="#california">
        ...
        <h1 id="services" className={`terms-heading ${highlightedSection === 'services' ? 'highlight' : ''}`}>
          1. OUR SERVICES 
        </h1>
        ...
        <h1 id="ip" className={`terms-heading ${highlightedSection === 'ip' ? 'highlight' : ''}`}>
          2. INTELLECTUAL PROPERTY RIGHTS
        </h1>
        ...
        <h2 className="terms-subheading">Your use of our Services</h2>
          ...
          <p>
            ...
            address your request to: __________. If we ever grant you the permission
        ...
        <h2 className="terms-subheading">Your submissions</h2>
            <p>
              ...
              </a>" section carefully prior to using our Services to understand the (a)
        ...
        <h1 id="userreps" className={`terms-heading ${highlightedSection === 'userreps' ? 'highlight' : ''}`}>
          3. USER REPRESENTATIONS
        </h1>
            <p>
        ...
        <h1 id="userreg" className={`terms-heading ${highlightedSection === 'userreg' ? 'highlight' : ''}`}>
          4. USER REGISTRATION
        </h1>
            <p>
        ...
        <h1 id="prohibited" className={`terms-heading ${highlightedSection === 'prohibited' ? 'highlight' : ''}`}>
          5. PROHIBITED ACTIVITIES
        </h1>
            <p>
          ...
          <ul className="terms-list">
            ...
            <li>
              ...
              that interferes with any party’s uninterrupted use and enjoyment of the Services or modifies, impairs, disrupts, alters, or interferes with the use, features, functions, operation, or maintenance of the Services.
            </li>
            ...
            <li>
              ...
              offline reader that accesses the Services, or using or launching any unauthorized script or other software.
            </li>
        ...
        <h1 id="ugc" className={`terms-heading ${highlightedSection === 'ugc' ? 'highlight' : ''}`}>
          6. USER GENERATED CONTRIBUTIONS
        </h1>
            <p>
        ...
        <h1 id="license" className={`terms-heading ${highlightedSection === 'license' ? 'highlight' : ''}`}>
          7. CONTRIBUTION LICENSE
        </h1>
        <p>
        ...
        <h1 id="socialmedia" className={`terms-heading ${highlightedSection === 'socialmedia' ? 'highlight' : ''}`}>
          8. SOCIAL MEDIA
        </h1>
        <p>
        ...
        <h1 id="advertisers" className={`terms-heading ${highlightedSection === 'advertisers' ? 'highlight' : ''}`}>
          9. ADVERTISERS
        </h1>
        <p>
        ...
        <h1 id="sitemanage" className={`terms-heading ${highlightedSection === 'sitemanage' ? 'highlight' : ''}`}>
          10. SERVICES MANAGEMENT
        </h1>
        <p>
        ...
        <h1 id="ppyes" className={`terms-heading ${highlightedSection === 'ppyes' ? 'highlight' : ''}`}>
          11. PRIVACY POLICY
        </h1>
        <p>
        ...
        <h1 id="modifications" className={`terms-heading ${highlightedSection === 'modifications' ? 'highlight' : ''}`}>
          13. MODIFICATIONS AND INTERRUPTIONS
        </h1>
        <p>
        ...
        <h1 id="law" className={`terms-heading ${highlightedSection === 'law' ? 'highlight' : ''}`}>
          14. GOVERNING LAW
        </h1>
        <p>
          These Legal Terms are governed by and interpreted following the laws of
          the State of Nevada, and the use of the United Nations Convention of
          ...
          provisions of the law of your country of residence. Diplomat and
          yourself both agree to submit to the non-exclusive jurisdiction of the
          courts of [Nevada], which means that you may make a claim to defend your
          consumer protection rights in regards to these Legal Terms in [Nevada],
          or in the EU country in which you reside.
        </p>

        <h1 id="disputes" className={`terms-heading ${highlightedSection === 'disputes' ? 'highlight' : ''}`}>
          15. DISPUTE RESOLUTION
        </h1>
        ...
        <p>
          ...
          in [County, Nevada]. Except as otherwise provided herein, the Parties
        ...
        <p>
          ...
          courts located in [County, Nevada], and the Parties hereby consent to,
        ...
        <h2 className="terms-subheading">Exceptions to Informal Negotiations and Arbitration</h2>
        <p>
        ...
        <h1 id="corrections" className={`terms-heading ${highlightedSection === 'corrections' ? 'highlight' : ''}`}>
          16. CORRECTIONS
        </h1>
        <p>
        ...
        <h1 id="disclaimer" className={`terms-heading ${highlightedSection === 'disclaimer' ? 'highlight' : ''}`}>
          17. DISCLAIMER
        </h1>
        <p>
          ...
          THIRD PARTY THROUGH THE SERVICES, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE
          OR MOBILE APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING, AND WE
        ...
        <h1 id="liability" className={`terms-heading ${highlightedSection === 'liability' ? 'highlight' : ''}`}>
          18. LIMITATIONS OF LIABILITY
        </h1>
        <p>
        ...
        <h1 id="indemnification" className={`terms-heading ${highlightedSection === 'indemnification' ? 'highlight' : ''}`}>
          19. INDEMNIFICATION
        </h1>
        <p>
        ...
        <h1 id="userdata" className={`terms-heading ${highlightedSection === 'userdata' ? 'highlight' : ''}`}>
          20. USER DATA
        </h1>
        <p>
        ...
        <h1 id="electronic" className={`terms-heading ${highlightedSection === 'electronic' ? 'highlight' : ''}`}>
          21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
        </h1>
        <p>
        ...
        <h1 id="california" className={`terms-heading ${highlightedSection === 'california' ? 'highlight' : ''}`}>
          22. CALIFORNIA USERS AND RESIDENTS
        </h1>
        <p>
        ...
        <h1 id="misc" className={`terms-heading ${highlightedSection === 'misc' ? 'highlight' : ''}`}>
          23. MISCELLANEOUS
        </h1>
        <p>
          ...
          these Legal Terms is determined to be unlawful, void, or unenforceable,
          that provision or part of the provision is deemed severable from these
          Legal Terms and does not affect the validity and enforceability of any
          ...
          Legal Terms or use of the Services. You agree that these Legal Terms will
        ...
        <h1 id="contact" className={`terms-heading ${highlightedSection === 'contact' ? 'highlight' : ''}`}>
          24. CONTACT US
        </h1>
        <p>
          In order to resolve a complaint regarding the Services or to receive
          further information regarding the use of the Services, please contact us
          at: Diplomat, 1411 Robin St, Las Vegas, NV 89106, United States.
        </p>
      </div>
    </div>
  );
